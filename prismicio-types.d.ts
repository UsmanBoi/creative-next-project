...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * View More field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
/**
 * Item in *TechList → Default → Primary → Tech Field*
 */
export interface TechListSliceDefaultPrimaryTechFieldItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech Field*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_field[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech Field*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_field[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech Field field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_field[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_field: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechFieldItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryTechFieldItem,
